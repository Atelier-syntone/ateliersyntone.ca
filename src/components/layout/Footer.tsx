        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto">
            ...
            <a
              ...
              className="group flex flex-col items-center gap-2 p-4 rounded-lg bg-white/5 hover:bg-white/10 transition-all duration-300"
            >
              ...
              <span className="font-corps text-xs text-white/60">@ateliersyntone</span>
